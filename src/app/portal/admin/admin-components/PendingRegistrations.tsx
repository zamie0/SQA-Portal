...
export function PendingRegistrations({ pendingUsers, setUserStatus }: { pendingUsers: any[], setUserStatus: (id: string, status: string) => void }) {
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        {pendingUsers.length === 0 && (
          <span className="ml-auto text-xs text-muted-foreground">No registrations awaiting approval.</span>
        )}
      </div>
