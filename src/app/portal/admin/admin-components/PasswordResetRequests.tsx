...
export function PasswordResetRequests({ pendingResets, oldResets, approveReset, rejectReset }: { pendingResets: any[], oldResets: any[], approveReset: (id: string, pw: string) => void, rejectReset: (id: string) => void }) {
  return (
...
function ResetRow({ reset, approveReset, rejectReset }: { reset: any, approveReset: (id: string, pw: string) => void, rejectReset: (id: string) => void }) {
