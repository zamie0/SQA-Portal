...
export const Route = createFileRoute("/tools/performance")({
  head: () => ({ meta: [{ title: "Performance Testing — SQA Portal" }] }),
  component: () => (
    <RequireAuth>
      <Page />
    </RequireAuth>
  ...
  return (
    <Shell>
      ...
      <section className="rounded-3xl glass p-6">
        ...
        <div className="mt-4">
          <Link to="/portal/tools" className="text-xs text-muted-foreground hover:text-foreground">
            ← Back to all tools
          </Link>
        </div>
      </section>
